...
export default function ReachOut() {
    return(
        <div className="sm:mx-[4rem] mx-[2rem] my-[8rem] sm:px-[5rem] px-0 text-center flex flex-col">
        <h1 className='sm:text-[3rem] text-[3rem] mb-[5rem] font-bold'>Meet The Developers</h1>
        <div className="flex justify-around sm:flex-row flex-col sm:gap-0 gap-[5rem]">
